...
* **BobsGame nD** – A modified version of the font in third/fourth generation Pokémon games with revised glyphs and support for more glyphs. The font will be used for nDworld. Windows Vista and newer fakes the font preview as Japanese (many Kanji letters not included in this font).
...
* **Pixel Sans Fallback** – For use in Japanese and Korean versions when the [game author](https://github.com/robertpelloni) makes the game fully translatable. Windows Vista and newer fakes the font preview as Japanese.
